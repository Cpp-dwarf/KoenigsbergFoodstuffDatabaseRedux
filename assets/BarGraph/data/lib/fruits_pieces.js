queue()
  .defer(d3.csv, "/files/theme/BarGraph/data/fruits_pieces_transformed.csv")
...
function tooltipText(d) {
 return "<h5>" + d.name + "</h5>" +
   ...
   "</tr>" +
      "<tr>" +
  "<td>Timeline data derived from Leopold von Ledebur, Schauplatz der Thaten oder Aufenthalts-Nachweis des Kurfürsten Friedrich Wilhelm des Großen. Berlin: W. Hayn, 1840 " + "</td>" +
  "</tr>" +
   "</table>";
}
...
function tooltipTimeline(d) {
  ...
  "<table>" +
  "<tr>" +
  "<td><strong>Percentage of Year</strong>: " + d3.format("%")(d.value) + "</td>" +
  "</tr><tr>" +
  "<td><strong>Percentage of Season</strong>: " + d3.format("%")(d.perc_season) + "</td>"
  "</tr><tr>" +
  "<td>Timeline data derived from Leopold von Ledebur, Schauplatz der Thaten oder Aufenthalts-Nachweis des Kurfürsten Friedrich Wilhelm des Großen. Berlin: W. Hayn, 1840 " + "</td>" +
  "</tr>" +
  "</table>";
